  ...
  return (
    <main className="flex h-screen flex-col items-center justify-center p-24 bg-[#354E95]/[.2]">
      ...
      >
        ...
        <section className="flex flex-col justify-center items-center ml-20 gap-4">
          ...
          <Link
            className="w-[150px] h-[40px] bg-[#FBFCFE] border border-[#DDE4F0] text-[#354E95] 
              shadow-[2px_2px_5px_1px_rgba(53,78,149,0.2)] rounded-md text-center flex items-center justify-center
              transition-transform duration-300 ease-in-out hover:scale-105 mt-7"
            href="/login"
            >
            Iniciar Sesion
          </Link>
