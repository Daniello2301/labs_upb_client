...
export default function Page() {
  return (
    <main className="flex h-screen m-h-screen flex-col items-center justify-center p-24 bg-[#354E95]/[.2]">
      <div className="relative min-w-[600px] min-h-[500px] bg-white rounded-sm flex items-center justify-center ">
